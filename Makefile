...
# LSM6DSL interface: I2C, SPI-3wire or SPI-4wire
IFACE=LSM6DSL_I2C
#IFACE=LSM6DSL_SPI3W
#IFACE=LSM6DSL_SPI4W
...
# -- Internal --
SPIN1_DRIVER_FN=sensor.imu.6dof.lsm6dsl.i2cspi.spin
SPIN2_DRIVER_FN=sensor.imu.6dof.lsm6dsl.i2cspi.spin2
